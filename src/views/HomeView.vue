<template>
    ...
    <div class="px-4 pt-5 my-3 text-center border-bottom">
      ...
      <div class="overflow-hidden" style="max-height: 50vh;">
        <div class="container px-5">
          <img src="../assets/image.png" v-if="!localdata.darkTheme"
               class="img-fluid border rounded-3 shadow-lg mb-4" alt="Single page - light" loading="lazy">
          <img src="../assets/image-dark.png" v-if="localdata.darkTheme"
  ...
  <div class="container px-4 py-5" id="instruction">
    ...
    <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
      <div class="col d-flex align-items-start">
        <div class="me-3">
          <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-film"
               viewBox="0 0 16 16">
            <path
      ...
      <div class="col d-flex align-items-start">
        <div class="me-3">
          <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-discord"
               viewBox="0 0 16 16">
            <path
      ...
      <div class="col d-flex align-items-start">
        ...
        <div>
          <h2>Шаг 3</h2>
          <p>
            Скопировать <code>url</code> с сайта Кинопоиск у <em class="text-muted">фильма / сериала / мультфильма /
            аниме</em>, вставить в поиск,
  ...
  <MainConfig :localdata="localdata"/>
  <DevConfig/>
</template>
